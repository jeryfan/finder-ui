            ...
            <div className="grid grid-cols-[repeat(auto-fill,minmax(90px,1fr))] gap-3">
              {sortedFiles.map((entry) => (
                <button
                  ...
                  onDoubleClick={(event) =>
                    handleEntryDoubleClick(entry, event)
                  }
            ...
            <div className="mt-0.5 space-y-0.5">
              {sortedFiles.map((entry) => (
                ...
                >
                  ...
                  <span
                    className={`${dateColumnClass} text-xs text-[#666666] truncate`}
                  >
                    {entry.lastModified
                      ? formatDateTimeEN(entry.lastModified)
                      : "--"}
                  </span>
                  <span
                    className={`${sizeColumnClass} text-xs text-[#666666] text-right`}
                  >
              ...
              {uploadingFiles.map((item, index) => (
                ...
                >
                  ...
                  <span className={`${dateColumnClass} text-xs text-[#666666]`}>
                    --
                  </span>
                  <span
                    className={`${sizeColumnClass} text-xs text-[#666666] text-right`}
